...
pkg_groups_map = {
    ...
    'mandriva-based':      ["cairo-devel",
                            ...
                            # Do all the "lib64" packages have "lib" aliases?
                            ...
                            "libadwaita-devel", "libayatana-appindicator3_1",
                                "libayatana-appindicator3-gir0.1", "libcairo-gobject2",
                                "libpython-devel", "libsystemd-devel", "libxkbcommon-devel",
                                "libnotify",
